...
var codegenerator = angular.module('CodeGenerator', ['ngNotify', 'ui.bootstrap', 'ui.select', 'switcher', 'ngFormValidation', 'angular.filter', 'angular-treeList', 'angular-baidu-map', 'angularMoment']);

codegenerator.run(['$rootScope', 'ngNotify', function ($rootScope, ngNotify) {
...
codegenerator.config(['$httpProvider', function ($httpProvider) {
...
codegenerator.config(['uibDatepickerPopupConfig', 'uibPaginationConfig', '$uibModalProvider', function (uibDatepickerPopupConfig, uibPaginationConfig, $uibModalProvider) {
...
codegenerator.controller('layout', ['$scope', '$window', '$http', '$uibModal', function ($scope, $window, $http, $uibModal) {
    $scope.menuTree = null;
...
codegenerator.controller('confirmCtrl', ['$scope', '$uibModalInstance', 'title', 'content', function ($scope, $uibModalInstance, title, content) {
    $scope.title = title;
