...
<div class="wrapper" ng-controller="layout" ng-init="findUserMenuTree()">
    <header class="main-header">
        <a href="${CodeGenerator.webRoot}" class="logo">
            <span class="logo-mini"><b>${CodeGenerator.title}</b></span>
            <span class="logo-lg"><b>${CodeGenerator.title}</b></span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="${CodeGenerator.webRoot}">${CodeGenerator.title}</a>.</strong> All rights reserved.
    </footer>
